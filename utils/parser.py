...
def get_omniglot_dagan_args():
    ...
    parser.add_argument(
        ...
        default='/home/PublicDir/luoshuai/data_preparation/Omniglot.npy'
    )
    parser.add_argument(
        "--final_model_path", type=str, help="Filepath to save final dagan model.",
        default='/home/PublicDir/luoshuai/final_model/g1.pth'
    )
    parser.add_argument(
        "--batch_size",
        nargs="?",
